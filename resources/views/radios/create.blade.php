...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-xl font-semibold mb-6" style="color: #0a2164">Add New Radio Station</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mt-1 flex items-center space-x-4">
                            <div class="inline-block h-16 w-16 rounded-full overflow-hidden bg-gray-100" id="logo-preview">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
